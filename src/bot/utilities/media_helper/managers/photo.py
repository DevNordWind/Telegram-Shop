...
from aiogram.types import FSInputFile, Message, PhotoSize, File, InlineKeyboardMarkup, ReplyKeyboardMarkup, \
...
class PhotoHelper(AbstractMediaHelper):
